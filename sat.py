...
def project_point_on_line(point, line):
    ...
    proj[0] = ((point[0] * line[0] + point[1] * line[1]) / (line[0]**2 + line[1]**2)) * line[0]
    proj[1] = ((point[0] * line[0] + point[1] * line[1]) / (line[0]**2 + line[1]**2)) * line[1]
    return proj
...
def main():
    ...
    print(separating_axis_theorem(test, c_vertices))
